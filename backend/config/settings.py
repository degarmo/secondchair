...
#
# Every origin the site is served from: the custom domain, its www form, and
# the onrender.com address, which keeps working alongside the domain.
CORS_ALLOWED_ORIGINS = list(
    dict.fromkeys(as_origin(v) for v in env_list("CORS_ALLOWED_ORIGINS"))
)
